...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      name: 'newsPage',
      component: () =>
        import('./views/newsPage/newsPage.vue')
    },
    {
      path: '/newsDetail',
      name: 'newsDetail',
      component: () =>
        import('./views/newsPage/newsDetail.vue')
    },
    {
      path: '/proPage',
      name: 'proPage',
      component: () =>
        import('./views/project/proPage.vue')
    },
    {
      path: '/proDetail',
      name: 'proDetail',
      component: () =>
        import('./views/project/proDetail.vue')
    },
    {
      path: '/ziyuanPage',
      name: 'ziyuanPage',
      component: () =>
        import('./views/ziyuan/ziyuanPage.vue')
    },
    {
      path: '/ziyuanDetail',
      name: 'ziyuanDetail',
      component: () =>
        import('./views/ziyuan/ziyuanDetail.vue')
    },
    {
      path: '/goodanliPage',
      name: 'goodanliPage',
      component: () =>
        import('./views/goodAnli/goodanliPage.vue')
    },
    {
      path: '/goodanliDetail',
      name: 'goodanliDetail',
      component: () =>
        import('./views/goodAnli/goodanliDetail.vue')
    },
    {
      path: '/anli',
      name: 'anli',
    ...
    },
    {
      ...
      name: 'recentlyList',
      component: () =>
        import('./views/marketing/recentlyList.vue')
    },
    {
      //学习列表
      path: '/learn',
    ...
    },
    {
      ...
      name: 'bTraining',
      component: () =>
        import('./views/marketing/businessTraining.vue')
    },
    {
      //销售技巧
      path: '/sales',
    ...
    },
    {
      ...
      name: 'anliList',
      component: () =>
        import('./views/marketing/anliList.vue')
    }, {
      //精选讲师，内部讲师，教师列表
      path: '/teacherList',
      name: 'teacherList',
    ...
    },
    {
      ...
      name: 'yxanliku',
      component: () =>
        import('./views/yxanliku/yxanliku.vue')
    },
    {
      path: '/speak',
      name: 'speak',
      component: () =>
        import('./views/speak/speak.vue')
    },
    {
      path: '/callphone',
      name: 'callphone',
      component: () =>
        import('./views/speak/callphone.vue')
    },
    {
      path: '/icon',
      name: 'icon',
      component: () =>
        import('./views/template/icon/Icon.vue'),
      meta: {
        title: "图标"
      }
    },
    {
      ...
      name: 'lookup',
      component: () =>
        import('./views/template/assembly/LookupPage.vue'),
      meta: {
        title: "选择组件"
      }
    },
    {
      ...
      name: 'form',
      component: () =>
        import('./views/template/assembly/FormPage.vue'),
      meta: {
        title: "表单组件"
      }
    },
    {
      ...
      name: 'baseform',
      component: () =>
        import('./views/template/assembly/form/BaseForm.vue'),
      meta: {
        title: "基础表单"
      }
    },
    {
      ...
      name: 'complexform',
      component: () =>
        import('./views/template/assembly/form/ComplexForm.vue'),
      meta: {
        title: "复杂表单"
      }
    },
    {
      ...
      name: 'buttonform',
      component: () =>
        import('./views/template/assembly/form/ButtonForm.vue'),
      meta: {
        title: "自定义按钮表单"
      }
    },
    {
      ...
      name: 'calendar',
      component: () =>
        import('./views/template/assembly/CalendarPage.vue'),
      meta: {
        title: "日历组件"
      }
    },
    {
      ...
      name: 'error',
      component: () =>
        import('./views/template/assembly/ErrorPage.vue'),
      meta: {
        title: "异常组件"
      }
    },
    {
      ...
      name: 'nav',
      component: () =>
        import('./views/template/hxe/NavigationBar.vue'),
      meta: {
        title: "设置标题栏"
      }
    },
    {
      ...
      name: 'list',
      component: () =>
        import('./views/template/page/List.vue'),
      meta: {
        title: "列表",
        rightButton: {
          type: 'image',
    ...
    },
    {
      ...
      name: 'search',
      component: () =>
        import('./views/template/page/Search.vue'),
      meta: {
        title: "搜索"
      }
    },
    {
      ...
      name: 'indexbar',
      component: () =>
        import('./views/template/page/IndexBar.vue'),
      meta: {
        title: "索引定位"
      }
    },
    {
      ...
      name: 'horizontal',
      component: () =>
        import('./views/template/page/Horizontal.vue'),
      meta: {
        title: "横屏显示"
      }
    },
    {
      ...
      name: 'grid',
      component: () =>
        import('./views/template/page/Grid.vue'),
      meta: {
        title: "表格"
      }
    },
    {
      ...
      name: 'temphome',
      component: () =>
        import('./views/template/page/TempHome.vue'),
      meta: {
        title: "主页"
      }
    }
