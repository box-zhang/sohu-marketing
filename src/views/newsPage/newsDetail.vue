<template>
	<div class="page">
		...
		<div v-if="responseobj&&responseobj!=null">
			<div class="iframe" v-if="istype==1">
				<iframe width="100%" height="100%" :src="responseobj.outUrl"></iframe>
			</div>
			</div>
			<div class="pdf" v-if="istype==2">
				<div class="iframe">
			...
			<div class="newsdiv" v-if="istype==3">
			    <div class="newsobj1">
...
export default {
  ...
  beforeDestroy(){
   ...
   methods: {
	  ...
	  // 获取菜文章
	  getIndexArticlebyid : function(){
	  		var _this = this
	  		var params = {
	  			id:this.dataobj.articleId
	  		}
	  	this.$http.post('indexModule/index-article/getById',params)
