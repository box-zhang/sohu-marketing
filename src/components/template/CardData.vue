...
.t-list-filter{
    ...
    .t-list-filter-type{
        ...
        .t-list-filter-item{
            ...
            border:.5px solid @neutral-border-color;
            font-size: @title-small-size;
    ...
    .t-list-item{
        ...
        .t-list-item-con{
            ...
            .t-list-item-tag-yellow{
                border:.5px solid @type-yellow-deeper-color;
                color:@type-yellow-deeper-color;
            }
            .t-list-item-tag-violet{
                border:.5px solid @type-violet-color;
                color:@type-violet-color;
            }
            .t-list-item-tag-blue{
                border:.5px solid @type-blue-color;
                color:@type-blue-color;
            }
            .t-list-item-tag-green{
                border:.5px solid @type-green-color;
        ...
        <div class="t-list-con">
            ...
            <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
                ...
                <van-list v-if="showImg&&!showMargin"
                        ...
                        @load="getData">
                    <div slot="loading" class="t-pull-load-area"><img src="../../assets/images/load.gif"/>加载中...</div>
                    <div v-for="(item,index) in list" :key="index" class="t-list-card" :class="index%2==0?'t-list-card-left':'t-list-card-right'">
                        <div class="t-list-item" :class="index%2==0?'t-list-item-left':'t-list-item-right'">
                            <div class="t-list-item-img">
                                <img :src="require(`../../assets/images/temp${item.img}.png`)"/>
                            </div>
                            <div class="t-list-item-con">
                            <van-row>
                                <van-col span="24"><div class="t-list-item-title van-ellipsis">{{item.name}}</div></van-col>
                            </van-row>
                            <van-row>
                                <van-col span="24">
                                    ...
                                    <div class="t-list-item-tag t-list-item-tag-green">{{item.status}}</div>
                                </van-col>
                            </van-row>
                            <van-row>
                            ...
                            <van-row>
                                <van-col span="10"><div class="t-list-item-lb">{{item.owner}}</div></van-col>
                                <van-col span="14"><div class="t-list-item-rb">{{item.createdon}}</div></van-col>
                            </van-row>
                            </div>
                        </div>
                    </div>
            ...
            <van-list v-if="showImg&&showMargin"
                    ...
                    <div slot="loading" class="t-pull-load-area"><img src="../../assets/images/load.gif"/>加载中...</div>
                    <div v-for="(item,index) in list" :key="index" class="t-list-card" :class="index%2==0?'t-list-card-left':'t-list-card-right'">
                        <div class="t-list-item t-list-item-withmargin" :class="index%2==0?'t-list-item-left':'t-list-item-right'">
                            <div class="t-list-item-img">
                                <img :src="require(`../../assets/images/temp${item.img}.png`)"/>
                            </div>
                            <div class="t-list-item-con">
